...
static const char *fonts[] = {
    // "JetBrainsMono Nerd Font Mono:style=Bold"};
...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = {0x7aa2f7ff, 0x1a1b26ff, 0x414868ff},
    [SchemeSel] = {0xf7768eff, 0x1a1b26ff, 0xf7768eff},
...
static const char *menucmd[] = {"wmenu-run", "-i", "-f",
                                "JetBrainsMono Nerd Font 16",
                                "-N", "1a1b26dd", "-n", "7aa2f7ff", 
                                "-M", "7aa2f7ff", "-m", "1a1b26dd", 
                                "-S", "7aa2f7ff", "-s", "1a1b26aa",
                                NULL};
...
static const Key keys[] = {
    ...
    // SHCMD("/home/tfarrell/.config/bin/screenshot.sh") }, {
    // MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_S,          spawn,
    // SHCMD("geom=\"$(slurp -f '%x,%y %wx%h')\"; grim -l 0 -g \"$geom\" - |
    // wl-copy") },
    {MODKEY, XKB_KEY_b, spawn, SHCMD("/home/tfarrell/.config/wmenu/bookmarks.sh")},
    {MODKEY, XKB_KEY_r, spawn, SHCMD("/home/tfarrell/.config/wmenu/repos.sh")},
    {MODKEY, XKB_KEY_period, spawn, SHCMD("/home/tfarrell/.config/wmenu/config.sh")},
    {MODKEY, XKB_KEY_x, spawn, SHCMD("/home/tfarrell/.config/bin/smart-clipboard.sh cut")},
    {MODKEY, XKB_KEY_c, spawn, SHCMD("/home/tfarrell/.config/bin/smart-clipboard.sh copy")},
    {MODKEY, XKB_KEY_v, spawn, SHCMD("/home/tfarrell/.config/bin/smart-clipboard.sh paste")},
    {MODKEY, XKB_KEY_t, spawn, SHCMD("/home/tfarrell/.config/bin/smart-clipboard.sh tab")},
    {MODKEY, XKB_KEY_a, spawn, SHCMD("/home/tfarrell/.config/bin/smart-clipboard.sh all")},
